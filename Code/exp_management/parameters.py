...
class Parameter:
    def __init__(self, name, type, default = None, value = None, min = None, max = None):
        self.name = name
        self.type = type
    ...
    def paramFromElement(element):
        ...
        if typeString == "int":
            ...
            param = IntParameter(name, default, value, rngMin, rngMax)
            ...
            param = FloatParameter(name, default, value, rngMin, rngMax)
...
class IntParameter(Parameter):
    def __init__(self, name, default = 0, value = 0, min = -2**31+1, max = 2**31-1):
        Parameter.__init__(self, name, "int", default, value, min, max)
...
class FloatParameter(Parameter):
    def __init__(self, name, default = 0.0, value = 0.0, min = -2**31+1, max = 2**31-1):
        Parameter.__init__(self, name, "float", default, value, min, max)
